...
/** Padrão legado (KYC autenticado). Register linear usa props próprias (15s). */
export const KYC_FACE_VIDEO_RECORD_MIN_MS = 5000;
export const KYC_FACE_VIDEO_RECORD_MAX_MS = 8000;

/** Gravação guiada no cadastro linear (15s, fases de 3s). */
export const KYC_FACE_VIDEO_REGISTER_MIN_MS = 12000;
export const KYC_FACE_VIDEO_REGISTER_MAX_MS = 15000;
