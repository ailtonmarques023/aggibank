          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  {...register('email', {
                    required: 'E-mail ou CPF é obrigatório',
                    pattern: {
                      value: /^([^\s@]+@[^\s@]+\.[^\s@]+|\d{3}\.?\d{3}\.?\d{3}-?\d{2})$/,
                      message: 'Digite um e-mail válido ou CPF'
                    }
                  })}
                  type="text"
                  autoComplete="email"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="ml-2">Gov.br</span>
              </button>
            </div>
          </div>
