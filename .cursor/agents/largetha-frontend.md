---
name: largetha-frontend
description: Especialista frontend do AgilBank. Use quando houver telas, eventos, UI, estados, componentes ou API client.
model: inherit
readonly: false
---
...
- UI que esconde erro critico atras de mensagem bonita
