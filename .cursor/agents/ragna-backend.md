---
name: ragna-backend
description: Especialista backend do AgilBank. Use quando houver API, banco, autenticacao, autorizacao, saldo, transacoes, persistencia, atomicidade ou idempotencia.
model: inherit
readonly: false
---
